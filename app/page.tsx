    ...
    <main className="overflow-hidden">
      ...
      <section className="relative overflow-hidden bg-slate-50 py-16 sm:py-20">
        ...
        <div className="container-section relative">
          ...
          <div className="mt-10 -mx-4 flex snap-x snap-mandatory gap-5 overflow-x-auto px-4 pb-5 [-ms-overflow-style:none] [scrollbar-width:none] sm:-mx-6 sm:px-6 lg:mx-0 lg:grid lg:grid-cols-3 lg:overflow-visible lg:px-0 lg:pb-0 [&::-webkit-scrollbar]:hidden">
            {audienceItems.map((item, index) => (
              <article key={item.title} className="group relative min-w-[86%] snap-center rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/8 transition duration-300 hover:-translate-y-1 hover:border-green-500/50 hover:shadow-2xl hover:shadow-green-900/15 sm:min-w-[58%] lg:min-w-0">
