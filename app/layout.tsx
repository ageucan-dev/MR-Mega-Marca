...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: faviconPngPath, type: "image/png", sizes: "512x512" },
      { url: faviconJpgPath, type: "image/jpeg", sizes: "512x512" },
    ],
    shortcut: [
      { url: faviconPngPath, type: "image/png" },
      { url: faviconJpgPath, type: "image/jpeg" },
    ],
